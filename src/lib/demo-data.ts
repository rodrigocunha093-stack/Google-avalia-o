...
export const demoStores: PublicStore[] = [
  ...
  store("cristo", "Rede Menor Preco Supermercados - Cristo", "Cristo", 4.2, 2188, -7.1458, -34.8756, [
    review("cristo", "Thiago Ferreira", 1, "Cliente relata pessima experiencia no acougue, demora no atendimento e recusa em fazer o corte solicitado no frango."),
    review("cristo", "Miltonjose Silva", 2, "Cliente relata que a loja tem preco acessivel, mas a recepcao foi ignorante ao tentar trocar um pedido na nota."),
    review("cristo", "Marcos Antonio", 2, "Cliente relata falta de respeito no horario de funcionamento, com pessoas dentro da loja e gerente sem orientar a entrada."),
    review("cristo", "Tarcio Viana", 1, "Cliente relata constrangimento recorrente por ser seguido por segurancas durante as compras."),
    review("cristo", "Marcio Ricardo", 1, "Cliente relata precos muito caros, pouca variedade, funcionarios ignorantes, caixa lento, falhas no cartao e filas enormes."),
    review("cristo", "SOCRATES MEDEIROS DOS SANTOS", 1, "Cliente relata pouca variedade, produtos vencidos, geladeiras desligadas a noite e precos mais caros que a concorrencia."),
    review("cristo", "Leandro Oliveira", 1, "Cliente relata funcionarios mal treinados e presenca de rato nas instalacoes da loja."),
    review("cristo", "Rafaela Oliveira", 1, "Cliente relata muitos produtos vencidos, bolo vencido e pao mofado, pedindo conferencia dos itens vendidos."),
  ]),
  store("torre", "Rede Menor Preco Supermercados - Torre", "Torre", 4.4, 1379, -7.1195, -34.8611, [
    review("torre", "Liliane Caleones", 2, "Cliente relata que a loja esta muito cara e com pouca opcao de produtos."),
    review("torre", "Marilia", 1, "Cliente relata muita sujeira dentro da loja e na calcada."),
    review("torre", "Jonatas Cesar", 2, "Cliente relata mais de 50 minutos em uma fila de 10 volumes, com demora excessiva no caixa."),
    review("torre", "Razec", 1, "Cliente pediu presunto de peru em promocao, mas ao abrir percebeu que recebeu apresuntado ou fiambre."),
    review("torre", "Celiane Amancio", 1, "Cliente relata experiencia nota zero apos comprar bandeja de ovos mofados na unidade Torre."),
    review("torre", "Josi", 1, "Cliente relata problemas no balcao dos frios e sugere visita da vigilancia sanitaria."),
    review("torre", "Rodrigo Gouveia", 1, "Cliente relata que o acougueiro se recusou a moer a carne, dando uma desculpa sem sentido."),
    review("torre", "Daniel JUNKES", 1, "Cliente relata que itens anunciados em promocao sao cobrados pelo preco original no caixa."),
    review("torre", "Dayane Costa", 1, "Cliente relata pessima experiencia apos comprar carne de charque estragada."),
    review("torre", "Robson Oliveira", 2, "Cliente relata ambiente apertado e gondola de carne com produtos fora do prazo de validade."),
  ]),
